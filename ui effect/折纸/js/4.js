...
var mask = list.querySelector('.mask');

var oneHeight = divs[0].offsetHeight;
// list.style.height = h2.offsetHeight + oneHeight * divs.length + 'px';
mask.style.height = h2.offsetHeight + 'px';


var timer = null;
//------------------delay to open or shrink-----------------------------------
function show() {
    mask.style.height = h2.offsetHeight + oneHeight * divs.length + 'px';
