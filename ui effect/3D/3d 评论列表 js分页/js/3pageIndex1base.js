...
function loadData(pageIndex) { //click first page, pageIndex = 1
    var messageListHtml = '';
...
(function loadPagination() {
    ...
    for (var i = 1; i <= pageCount; i++) {
        if (i == currentPageIndex) {
            paginationHtml += '<a href="javascript:;" class="active">' + i + '</a>';
        } else {
            paginationHtml += '<a href="javascript:;">' + i + '</a>';
        }
    }
    ...
    for (var i = 0; i < aPages.length; i++) {
        ...
        aPages[i].onclick = function() {
            ...
            aPages[currentPageIndex - 1].className = '';
    ...
    aCollection[0].onclick = function() {
        aPages[currentPageIndex - 1].className = '';
        currentPageIndex = 1;
        aPages[currentPageIndex - 1].className = 'active';
