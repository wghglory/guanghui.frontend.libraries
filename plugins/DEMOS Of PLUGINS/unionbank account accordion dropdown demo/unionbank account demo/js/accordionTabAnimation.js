...
function bindAccordionLiClick() {
    ...
    var contentDivs = document.querySelectorAll('.content>div'); //li corresponding div
    ...
    for (var i = 0; i < lis.length; i++) {
        ...
        lis[i].onclick = function() {
            ...
            if (previousClickedLi != null) {
                removeClass(previousClickedLi, 'active');
                // console.log('outer: '+previousClickedLi.index);

                var preClickedIndex = previousClickedLi.index;

                contentDivs[previousClickedLi.index].className = 'fadeOut';
            ...
            rightContent.style.height = (contentDivs[this.index].offsetHeight + 1) + 'px';
